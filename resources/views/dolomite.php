            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div class="service-item-box service-details-content">
                        ...
                        <h3>Dolomite</h3>
                        <br />
                        <p> Dolomite is a type of limestone. One of the three most abundant carbonate minerals. It is rich in magnesium and calcium carbonate. It differs from calcite and aragonite, which are the other two carbonate minerals, in its crystal structure.
                            Crystals of dolomite are common in hydrothermal vein deposits and sedimentary rocks called dolostone, where fill pores in their host rock.
                            They serve as the host rock for many lead, zinc and copper deposits.
                        </p>
                        <br />

                        <p>
                           Dolomites are used in the Paint industry, Glass industry, Ceramic industry, Detergent industry. The dolomite lumps we produce are slightly harder, shiny, denser and never forms scalenohedrons. Kiran Minerals are well-known for the manufacturing, exporting and supplying of dolomites in a safe industrial grade packing from Rajasthan (India).
                            our company has the capacity to produce bulk dolomites on request.
                        </p>
						...
						<div class="row">
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="single-portfolio-style-two">
										<a><img src="img/dolo/1.jpg" alt="Awesome Image"/></a>
								</div><!-- /.single-portfolio-style-two -->
							</div>
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="single-portfolio-style-two">
										<a><img src="img/dolo/2.jpg" alt="Awesome Image"/></a>
								</div><!-- /.single-portfolio-style-two -->
							</div>
						</div>
                                        ...
                                        <div class="inner">
                                            <div class="row">
												<div>
													<div class="col-md-4 col-sm-6 col-xs-12">
														<ul class="meta-info">
															<li><i class="fa fa-tag"></i><span>Source of Magnesia(MgO)</span></li>
															<li><i class="fa fa-tag"></i><span>Sintering agent</span></li>
															<li><i class="fa fa-tag"></i><span>Flux in metal processing</span></li>
														</ul><!-- /.meta-info -->
													</div>
												</div>
												<div>
													<div class="col-md-4 col-sm-6 col-xs-12">
														<ul class="meta-info">
															<li><i class="fa fa-tag"></i><span>Glass production</span></li>
															<li><i class="fa fa-tag"></i><span>Bricks</span></li>
