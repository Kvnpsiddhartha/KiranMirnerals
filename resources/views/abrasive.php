            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div class="service-item-box service-details-content">
                        ...
                        <h3>Abrasive Sand</h3>
                        <br />
                        <p> Abrasive sand is mostly used as an alternative to silica sand because it produces less dust and very safe than silica sand.
                            They are commonly used to remove impurities from surfaces since the sand has same size and the edges of the particles are sharp.
                            Kiran Minerals is well-known for the manufacturing and supplying of quality abrasive.
                        </p>
                        <br />
						<br />
						...
						<div class="row">
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="single-portfolio-style-two">
										<a><img src="img/abrasive/1.jpg" alt="Awesome Image"/></a>
								</div><!-- /.single-portfolio-style-two -->
							</div>
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="single-portfolio-style-two">
										<a><img src="img/abrasive/2.jpg" alt="Awesome Image"/></a>
								</div><!-- /.single-portfolio-style-two -->
							</div>
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="single-portfolio-style-two">
										<a><img src="img/abrasive/3.jpg" alt="Awesome Image"/></a>
								</div><!-- /.single-portfolio-style-two -->
							</div>
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="single-portfolio-style-two">
										<a><img src="img/abrasive/4.jpg" alt="Awesome Image"/></a>
								</div><!-- /.single-portfolio-style-two -->
							</div>
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="single-portfolio-style-two">
										<a><img src="img/abrasive/5.jpg" alt="Awesome Image"/></a>
								</div><!-- /.single-portfolio-style-two -->
							</div>
						</div>
                                        ...
                                        <div class="inner">
                                            <div class="row">
												<div>
													<div class="col-md-4 col-sm-6 col-xs-12">
														<ul class="meta-info">
															<li><i class="fa fa-tag"></i><span>Surface preparation</span></li>
															<li><i class="fa fa-tag"></i><span>Coating</span></li>
															<li><i class="fa fa-tag"></i><span>Removing rust, scale</span></li>
														</ul><!-- /.meta-info -->
													</div>
												</div>
												<div>
													<div class="col-md-4 col-sm-6 col-xs-12">
														<ul class="meta-info">
															<li><i class="fa fa-tag"></i><span>Roughing industrial gas turbine engine</span></li>
                                                            <!--
